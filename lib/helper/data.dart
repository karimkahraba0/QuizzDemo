...
// this method to return a list of question (models)
List<QuestionModel> getQuestions() {
  // define the list of questions (models)
  List<QuestionModel> questions =  List<QuestionModel>();
  // make an instance from QuestionModel to use
  ...
  // to add question to the list of question (models)
  questions.add(questionModel);
  // to remove previous values and make another
